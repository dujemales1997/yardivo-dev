...
const syncApi={
  ...
  broadcastChange,
  online,
  status:()=>({ready:!!ready,pending:pending(),realtime:realtimeStatus,tokenExp}),
  recover:recoverCanonicalConnection,
  resetAllExceptUsers,
  fullDataSnapshot,
  restoreFullData
};
window.YardivoSync=syncApi;
window.YardivoSupabase=syncApi;
window.YardivoOnlineSync=syncApi;
try{
